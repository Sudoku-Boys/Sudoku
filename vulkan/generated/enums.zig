// Enum for VK_SAMPLER_ADDRESS_MODE_
...
// Enum for VK_VERTEX_INPUT_RATE_
...
// Enum for VK_FRONT_FACE_
pub const FrontFace = enum(u32) {
    CounterClockwise = 0,
    Clockwise = 1,
};

// Enum for VK_ATTACHMENT_LOAD_OP_
...
// Enum for VK_SAMPLER_MIPMAP_MODE_
pub const MipmapMode = enum(u32) {
    Nearest = 0,
    Linear = 1,
};

// Enum for VK_SHARING_MODE_
...
// Enum for VK_ATTACHMENT_STORE_OP_
